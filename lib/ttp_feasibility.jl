...
function delta_feasibility_check(ttp_instance::Main.TTPInstance.Instance, node, away_team::Int64, home_team::Int64, dead_teams_check::Bool)
...
# incrementally check whether playing (away_team, home_team) would result into a state without a feasible completion for certain according to our checks
function delta_feasibility_check_no_dead_teams(ttp_instance::Main.TTPInstance.Instance, node, away_team::Int64, home_team::Int64, away_team_home_games_left, away_team_away_games_left, home_team_home_games_left, home_team_away_games_left)
    if !delta_at_most_check(ttp_instance, node, away_team, home_team, away_team_home_games_left, away_team_away_games_left, home_team_home_games_left, home_team_away_games_left)
        return false
    end
...
function delta_at_most_check(ttp_instance::Main.TTPInstance.Instance, node, away_team::Int64, home_team::Int64, away_team_home_games_left::Int64, away_team_away_games_left::Int64, home_team_home_games_left::Int64, home_team_away_games_left::Int64)
...
function delta_no_repeat_check(ttp_instance::Main.TTPInstance.Instance, node, away_team::Int64, home_team::Int64, away_team_home_games_left::Int64, away_team_away_games_left::Int64, home_team_home_games_left::Int64, home_team_away_games_left::Int64)
...
function delta_infer_no_dead_team(ttp_instance::Main.TTPInstance.Instance, layer::Int64, state, team::Int64, team_home_games_left::Int64, team_away_games_left::Int64, teams_away_streak_limit_hit_last_round::Int64, teams_away_streak_limit_hit_current_round::Int64, teams_home_stand_limit_hit_last_round::Int64, teams_home_stand_limit_hit_current_round::Int64)
...
function delta_check_dead_team(ttp_instance::Main.TTPInstance.Instance, node, away_team::Int64, home_team::Int64)
    state = update_state(ttp_instance, node.state, away_team, home_team, node.number_of_away_games_left[home_team], node.number_of_home_games_left[away_team])
...
function number_of_permitted_games_for_team_by_check(ttp_instance::Main.TTPInstance.Instance, node, team::Int64)
...
function game_allowed(ttp_instance::Main.TTPInstance.Instance, state, away_team::Int64, home_team::Int64)
...
function future_game_allowed(ttp_instance::Main.TTPInstance.Instance, state, team::Int64, opponent::Int64, away_team::Int64, home_team::Int64)
...
function delta_game_allowed(ttp_instance::Main.TTPInstance.Instance, state, team::Int64, opponent::Int64, away_team::Int64, home_team::Int64)
