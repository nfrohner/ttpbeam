...
@testset "heuristic estimates" begin
    ...
    @test TTPNodeEstimators.max_vehicles_by_away_games(ttp_instance, 1, [2,3,4,5,6,7,8], 7, 1, 0) == 7
    @test TTPNodeEstimators.max_vehicles_by_away_games(ttp_instance, 1, [3,4,5,6,7], 6, 2, 1) == 6
    @test TTPNodeEstimators.max_vehicles_by_away_games(ttp_instance, 1, [4,5,6,7], 6, 3, 2) == 5
    @test TTPNodeEstimators.max_vehicles_by_away_games_triangle(ttp_instance, 1, [2,3,4,5,6,7,8], 7, 1, 0) == 4
    @test TTPNodeEstimators.max_vehicles_by_away_games_triangle(ttp_instance, 1, [3,4,5,6,7], 6, 2, 1) == 3
    @test TTPNodeEstimators.max_vehicles_by_away_games_triangle(ttp_instance, 1, [4,5,6,7], 6, 3, 2) == 3
    ...
    @test TTPNodeEstimators.min_max_vehicles(ttp_instance, 1, [2,3,4,5,6,7,8], 7, 1, 0) == (3, 7)
    @test TTPNodeEstimators.min_max_home_stands(ttp_instance, 1, [2,3,4,5,6,7,8], 7, 1, 0) == (4, 8)
    @test TTPNodeEstimators.min_max_home_stands(ttp_instance, 1, [2,3,4,5,6,7,8], 4, 1, 3) == (4, 6)
    @test TTPNodeEstimators.min_max_vehicles(ttp_instance, 1, [4,5,6,7], 6, 3, 2) == (2, 5)
    ...
    @test TTPNodeEstimators.min_max_vehicles(ttp_instance, 1, [6,7,8,9,10], 7, 5, 1) == (3, 6)
    @test TTPNodeEstimators.min_max_home_stands(ttp_instance, 1, [6,7,8,9,10], 7, 5, 1) == (3, 6)
end
